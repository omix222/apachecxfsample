...
public class HelloWorldResource {
     ...
     * Unknown elements from provider are filtered out automatically.
     */
    ...
    private HelloWorld createClientWithLogging() {
        ...
        handlerChain.add(new UnknownElementFilter(getObjectFactoryClass(HelloWorldService.class)));
    ...
    /**
     * Get ObjectFactory class from the same package as the service class.
     * ObjectFactory is auto-generated by CXF from WSDL.
     */
    private Class<?> getObjectFactoryClass(Class<?> serviceClass) {
        String packageName = serviceClass.getPackageName();
        String objectFactoryName = packageName + ".ObjectFactory";
        try {
            return Class.forName(objectFactoryName);
        } catch (ClassNotFoundException e) {
            throw new RuntimeException("ObjectFactory not found in package: " + packageName, e);
        }
    }
}
